...
#include <memory>
#include "../../blueToothEx/customframe.h"
...
void CustomFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CustomFrame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CustomFrame::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomFrame::clicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CustomFrame::staticMetaObject = { {
    QMetaObject::SuperData::link<QFrame::staticMetaObject>(),
    qt_meta_stringdata_CustomFrame.data,
    qt_meta_data_CustomFrame,
    qt_static_metacall,
    nullptr,
    nullptr
} };
